...
<?php }else{ ?>
  ...
  <button class="btn-custom button-color-scheme1 buttonActionRegistrationSeparate mt25 width100" ><?php echo translate("tr_e9c3a648ce9e5dcf3c96940e682a72a2"); ?></button>
