...
$(document).ready(function () {
   ...
   function loadReports(){
      ...
      helpers.request({url:"dashboard-mobile-app-stat-load-data-chart", checkAccess: false}, function(data) {
         ...
         const weeklyReports = new ApexCharts(document.querySelector('#weeklyMobileAppStatReports'), weeklyReportsConfig);
        ...
        var monthReports = new ApexCharts(document.querySelector("#monthMobileAppStatReports"), monthReportsConfig);
        monthReports.render();
