        ...
        <div class="text-end pt-3 pt-md-0">
          ...
          <div class="btn-group">
              <select class="form-select selectpicker formControlDefaultFilters" name="filter[status]" >
                ...
                <option value="0" {% if(compareValues($_POST['filter']['status'], 0)){ echo 'selected=""'; } %} >{{ translate("tr_d9d74d385363cf3fdf9c1e62b484acca") }}</option>
                <option value="1" {% if(compareValues($_POST['filter']['status'], 1)){ echo 'selected=""'; } %} >{{ translate("tr_7a51ba13af2f08144b7c9184fdece0a6") }}</option>
              </select>
          </div>
          </div>
