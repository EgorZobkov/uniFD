...
<div class="row g-4">
  ...
  <div class="col-12">
    ...
    {% component users/statistics.tpl %}
    ...
    <div class="card">
          ...
          <div class="actionsWithSelectedItems" >
            <div class="btn-group">
              ...
              <ul class="dropdown-menu" >
                <li><span class="dropdown-item actionUsersMultiDelete" >{{ translate("tr_ed2bbfbc53d83d3ad81f7fd6485ac6e8") }}</span></li>
              </ul>
            </div>
          </div>
          ...
          <div class="control-filters-container-item" >
              <div class="btn-group">
                ...
                <ul class="dropdown-menu width100" >
                  <li><span class="dropdown-item openModal" data-modal-id="addUserModal" >{{ translate("tr_5eba283b81890978e67f4aa96dde1724") }}</span></li>
                </ul>
              </div>
          </div>
      ...
      {{ $template->ui->tpl('users/control-filters.tpl')->modal("controlFilters", "small"); }}

      </form>

      {% component users/list.tpl %}
...
{{ $template->ui->tpl('users/add-user.tpl')->modal("addUser", "medium"); }}
{{ $template->ui->tpl('users/add-user-success.tpl')->modal("addUserSuccess", "small"); }}
