...
<div class="nav-align-top mb-4">
  <ul class="nav nav-pills flex-column flex-md-row flex-wrap mb-6 row-gap-2">
    <li class="nav-item"><a class="nav-link waves-effect waves-light" href="{{ $template->router->getRoute('dashboard-transactions') }}">{{ translate("tr_cecdd096144eccaeb28c4c2bc233ed63") }}</a></li>
    <li class="nav-item"><a class="nav-link active waves-effect waves-light" href="{{ $template->router->getRoute('dashboard-transactions-operations') }}">{{ translate("tr_1ec0db83a649974785419afafde20176") }}</a></li>
  </ul>
</div>
...
<div class="row g-4">
  ...
  <div class="col-12">
    ...
    <div class="card">
      ...
      {% component transactions/operation-list.tpl %}
