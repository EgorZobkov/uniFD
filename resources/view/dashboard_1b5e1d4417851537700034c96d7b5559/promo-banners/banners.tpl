...
<div class="row g-4">
  ...
  <div class="col-12">
    ...
    <div class="card">
          ...
          <div class="btn-group">
              ...
              <div class="btn-group">
                ...
                <ul class="dropdown-menu width100" >
                  <li><span class="dropdown-item openModal" data-modal-id="addPromoBannerModal" >{{ translate("tr_5eba283b81890978e67f4aa96dde1724") }}</span></li>
                </ul>
              </div>
      ...
      {% component promo-banners/list.tpl %}
...
{{ $template->ui->tpl('promo-banners/add.tpl')->modal("addPromoBanner", "medium"); }}
