  ...
  <div class="col-12 col-md-12">
    ...
    <div class="nav-align-top mb-4">
      <ul class="nav nav-pills flex-column flex-md-row">
        <li class="nav-item">
          <a class="nav-link" href="{{ $template->router->getRoute('dashboard-ads-filters'); }}">{{ translate("tr_f7ac6fc5c5a477063add9c6d0701985d") }}</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="{{ $template->router->getRoute('dashboard-ads-filters-links'); }}">{{ translate("tr_9f58935eaf5d4cdda0f114e4f325ed0f") }}</a>
        </li>
    </div>
    ...
    <div class="card" >
        ...
        <div class="card-header flex-column flex-md-row">
          <div class="text-end pt-3 pt-md-0">
            ...
            <div class="btn-group">
                ...
                <select class="form-select selectpicker formControlDefaultFilters" data-live-search="true" title="{{ translate("tr_53660e081bed47bc53e7d4d247f7b15d") }}" name="filter[category_id]" >
            ...
            <div class="btn-group">
                ...
                <div class="btn-group">
                  ...
                  <ul class="dropdown-menu width100" >
                    <li><span class="dropdown-item openModal" data-modal-id="addFilterLinkModal" >{{ translate("tr_75cd99e9ba4a1aa5922f9ce3f54c1744") }}</span></li>
                  </ul>
                </div>
      ...
      {% component board/filters/list-links.tpl %}
...
{{ $template->ui->tpl('board/filters/add-filter-link.tpl')->modal("addFilterLink", "medium"); }}