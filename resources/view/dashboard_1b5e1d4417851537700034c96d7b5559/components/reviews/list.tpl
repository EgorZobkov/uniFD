...
$data = $app->model->reviews->pagination(true)->page($_POST['page'])->output($_POST['output'])->filter($_POST['filter'])->sort('id desc')->getAll("parent_id=?", [0]);
            ...
            <tr>
              ...
              <td class="text-end" >
                ...
                <div class="flex-column flex-md-row align-items-center text-end">
                  ...
                  <button class="btn btn-icon btn-sm btn-label-primary waves-effect waves-light loadEditReview" data-id="<?php echo $value['id']; ?>" >
...
<?php
   ...
   echo $app->ui->wrapperInfo("dashboard-improv", ["filter"=>$_POST['filter'], "title"=>translate("tr_5781a644de7a7276ce1b079f9f27fafe"), "subtitle"=>translate("tr_4cad5dde390cc8e35127e774c54fe1c0")]);
}
?>