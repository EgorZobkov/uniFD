...
<div class="mb-4">
  <h2 class="role-title font-weight-bold"><?php echo translate("tr_9f47d6d8941081ab76493d6c09336f20"); ?></h2>
</div>

<form class="row g-3 formAddRegion" >
  <div class="col-12">
    <div>
      <label class="switch">
  ...
  <div>
    <div class="mt-4 d-grid gap-2 col-lg-6 mx-auto">
      <button class="btn btn-primary buttonAddRegion"><?php echo translate("tr_5eba283b81890978e67f4aa96dde1724"); ?></button>
    </div>
  </div>
