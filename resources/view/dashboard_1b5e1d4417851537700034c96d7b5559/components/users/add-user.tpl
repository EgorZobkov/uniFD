<div class="mb-4">
  <h2 class="role-title font-weight-bold"><?php echo translate("tr_331146cdf7b1718839f330946452c8ce"); ?></h2>
</div>
...
<form class="formAddUser" >
  ...
  <div class="row g-3" >
    ...
    <div class="col-12">
      <label class="form-label label-bold" ><?php echo translate("tr_351e768198138677a61c9e5e0153ef92"); ?></label>
      
      <select class="form-select select-status-user selectpicker" name="status" >
        <?php echo $app->component->users->outAllStatusesOptions(); ?>
      </select>

    </div>
    <div class="container-change-reason-blocking" >
      <div class="col-12">
    ...
    <div class="col-12">
      ...
      <select class="form-select select-role-user selectpicker" name="role_id" >
        <option value="" ><?php echo translate("tr_591cca300870eb571563ef4b8c8756ff"); ?></option>
        <?php echo $app->component->users->outAllRolesOptions(); ?>
      </select>
    ...
    <div class="col-12">
      ...
      <?php echo $app->ui->managerFiles(["type"=>"images", "path"=>"user-avatar"]); ?>
    ...
    <div class="col-6">
      <label class="form-label label-bold" >Email</label>
    ...
    <div class="col-6">
      ...
      <div class="containerPhoneAllCountry" >
        <input type="text" name="phone" class="form-control inputPhoneAllCountry" />
    ...
    <div class="container-privileges-user" >
      <div class="col-12">
              ...
              <tr>
                ...
                <td>
                  <div class="form-check">
                    <input class="form-check-input select-all-checkbox" type="checkbox" id="new-admin-select-all-checkbox" />
                    <label class="form-check-label" for="new-admin-select-all-checkbox"> <?php echo translate("tr_4d09821e5f0ae6b496ac3211da10f88b"); ?> </label>
                  </div>
                </td>
              </tr>

              <?php echo $app->user->outTablePrivileges(); ?>          
  ...
  <div class="mt-4 d-grid gap-2 col-lg-6 mx-auto">
    <button class="btn btn-primary buttonAddUser"><?php echo translate("tr_5eba283b81890978e67f4aa96dde1724"); ?></button>
  </div>
