...
<form class="formEditServiceTariff" >
...
<div class="row g-3" >
  ...
  <div class="col-12">
    ...
    <label class="switch">
      ...
      <span class="switch-label" ><?php echo translate("tr_c577227aae90d8684e771ba1b2b53094"); ?></span>
    </label>          
  ...
  <div class="col-12">
    ...
    <label class="switch">
      <input type="checkbox" class="switch-input" name="onetime" value="1" <?php if($data->onetime){ echo 'checked=""'; } ?> >
      <span class="switch-toggle-slider">
        <span class="switch-on"></span>
        <span class="switch-off"></span>
      </span>
  ...
  <div class="col-12">
    <label class="form-label" ><?php echo translate("tr_4e1a0e95e6e3f392f99811caba17f550"); ?></label>

    <div class="row" >
      <div class="col-6" >
        
        <select class="selectpicker" name="items[]" multiple title="<?php echo translate("tr_591cca300870eb571563ef4b8c8756ff"); ?>" >
           <?php echo $app->component->service_tariffs->outItemsOptions(_json_decode($data->items_id)); ?>
        </select>
...
<div class="mt-4 d-grid gap-2 col-lg-6 mx-auto">
  <button class="btn btn-primary buttonSaveEditServiceTariff"><?php echo translate("tr_74ea58b6a801f0dce4e5d34dbca034dc"); ?></button>
</div>
