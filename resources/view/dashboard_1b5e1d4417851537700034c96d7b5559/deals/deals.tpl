...
<div class="row g-4">
  ...
  <div class="col-12">
    ...
    {% component deals/statistics.tpl %}
    ...
    <div class="card">
      ...
      <form class="formControlFilters" >
        ...
        <div class="card-header flex-column flex-md-row">
          <div class="text-end pt-3 pt-md-0">
            ...
            <div class="control-filters-container-item" >
              <div class="btn-group">
                <button type="button" class="btn btn-label-secondary waves-effect waves-light openModal" data-modal-id="controlFiltersModal" >Фильтр {% if($_POST['filter']){ echo '<span class="badge badge-dot bg-danger ms-1"></span>'; } %}</button>
              </div>
            </div>
        ...
        {{ $template->ui->tpl('deals/control-filters.tpl')->modal("controlFilters", "small"); }}

      </form>

      {% component deals/list.tpl %}
