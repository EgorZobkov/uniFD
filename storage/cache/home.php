...
<meta property="og:image" content="<?php echo $template->storage->logo(); ?>">
...
<div class="row" >
 ...
 <div class="col-md-12" >
   ...
   <div class="home-widget-sections"  >
     ...
     <?php foreach($template->component->settings->getFrontendHomeWidgets() as $value):; ?>
     
         <?php if($value["code"] == "slider_categories"):; ?>

         <section class="widget-categories-container d-none d-lg-flex" ><?php echo $template->component->home->outCategories(); ?></section>

         <?php endif; ?>

         <?php if($value["code"] == "promo_banners"):; ?>

         <section class="widget-promo-banners-container" ><?php echo $template->component->home->outPromoBanners(); ?></section>

         <?php endif; ?>

         <?php if($value["code"] == "stories"):; ?>

         <section class="widget-stories-container" ><?php echo $template->component->home->outStories(); ?></section>

         <?php endif; ?>

         <?php if($value["code"] == "shops"):; ?>

         <section class="widget-shops-container" ><?php echo $template->component->home->outShops(); ?></section>

         <?php endif; ?>

         <?php if($value["code"] == "articles_blog"):; ?>

         <section class="widget-articles-blog-container" ><?php echo $template->component->home->outArticlesBlog(); ?></section>

         <?php endif; ?>

         <?php if($value["code"] == "ads_categories"):; ?>

         <section class="widget-ads-categories-container" ><?php echo $template->component->home->outAdsByCategories(); ?></section>

         <?php endif; ?>

         <?php if($value["code"] == "vip_ads"):; ?>

         <section class="widget-ads-vip-container" ><?php echo $template->component->home->outAdsVip(); ?></section>

         <?php endif; ?>

         <?php if($value["code"] == "ads"):; ?>

         <section class="widget-ads-container" >

            <div class="bold-title-and-link" >
               <span><?php echo translate("tr_a0825e8ab6d3fdb685be22c1c21d9ebc"); ?></span>
            </div>
    ...
    <div class="container-item-grid-content-skeleton" >
     ...
     <?php if($seo->h1):; ?>
         <section class="home-seo-text" >
            <h1 class="font-bold mb15" ><?php echo $seo->h1; ?></h1>
            <?php echo $seo->text; ?>
         </section>
     <?php endif; ?>
