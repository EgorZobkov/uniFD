...
<div class="header-menu-filters-mobile-container" >
    ...
    <div class="search-map-sidebar-control-mobile" >
        ...
        <div class="row" >
            <div class="col-lg-8" >
                <?php if($_GET["c_id"]):; ?>
                <div class="mb5" ><strong><?php echo $template->component->ads_categories->chainCategory($_GET["c_id"])->chain_build; ?></strong></div>
                <?php endif; ?>
                <span class="actionSaveSearch catalog-container-links-inline-item">👉 <?php echo translate("tr_0f724ec88b1fc82527e8097190f4fa5c"); ?></span>
            </div>
            <div class="col-lg-4 text-end" >
                 <div class="btn-custom-mini button-color-scheme1 actionMapShowFilters" ><?php echo translate("tr_f7ac6fc5c5a477063add9c6d0701985d"); ?> <?php if($_GET["filter"]):; ?><span class="badge badge-dot bg-danger ml5 badge-dot"></span><?php endif; ?> </div>
            </div>
        </div>
  ...
  <div class="container-item-grid-skeleton" >
    ...
    <div class="search-map-sidebar-filters" >
        ...
        <div class="search-map-sidebar-filters-control text-end" >
            <div class="btn-custom-mini button-color-scheme2 actionMapCloseFilters" ><?php echo translate("tr_dd9463bd5d0c650b468fc5d6cfa1073c"); ?></div>
        </div>

        <form class="live-filters search-map-sidebar-filters-container" >

          <div class="params-form-item params-form-item-categories" >
              <label class="params-form-item-label" ><?php echo translate("tr_c95a1e2de00ee86634e177aecca00aed"); ?></label>
              <div class="params-form-item-subcategories" >
                <?php echo $template->component->ads_categories->outReverseCategories($_GET["c_id"]); ?>
              </div>
          </div>

          <?php echo $template->component->catalog->buildParamsForm($_GET, $_GET["c_id"], false);; ?>
          ...
          <div class="search-map-sidebar-filters-buttons" >
            ...
            <?php if($_GET["filter"]):; ?>
            <button class="btn-custom button-color-scheme4 width100 mt5 actionClearLiveFilters"><?php echo translate("tr_02d901c131a1b8c2d1dd669e1f6c88a5"); ?></button>
            <?php endif; ?>
    ...
    <?php echo $template->component->geo->outMapSearchItems(); ?>
