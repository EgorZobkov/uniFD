...
<div class="row" >
  ...
  <div class="col-md-3" >
    ...
    <div class="profile-user-sidebar-avatar" >
      <div>
        ...
        <img class="image-autofocus" src="https://my-fd.ru/storage/users/avatars/1d5a75d07b1ddf7b4fae9757a7326103.webp">
      </div>
    </div>
  ...
  <div class="col-md-9" >
        ...
        <div class="my-tabs-items my-tabs-items-medium mt20">
            <a class="my-tabs-item <?php if(!$_GET['tab'] || compareValues($_GET['tab'], 'my_reviews')){ echo 'active'; }; ?>" href="?tab=my_reviews" ><?php echo translate("tr_be785795f5671c67bb5115a4ee2b5069"); ?></a>
            <a class="my-tabs-item <?php if(compareValues($_GET['tab'], 'added')){ echo 'active'; }; ?>" href="?tab=added" ><?php echo translate("tr_8cdd004eb3181c7b872757b8018af33d"); ?></a>
        </div>
