               ...
               <div class="col-lg-3 text-end" >
                  ...
                  <div class="header-wow-top-list-icon" >
                    ...
                    <div class="header-wow-top-list-profile">
                        <div class="header-user-dropdown-menu"> <span> <span class="mini-avatar"> <span class="mini-avatar-img">     <img class="image-autofocus" src="/storage/users/avatars/c879900f50aaf785fde3e94726695b1e.webp">
     </span> </span>
    </span>
...
<div class="row" >
  ...
  <div class="col-md-3" >
    ...
    <div class="profile-user-sidebar-avatar" >
      <div>
        ...
        <img class="image-autofocus" src="https://my-fd.ru/storage/users/avatars/c879900f50aaf785fde3e94726695b1e.webp">
      </div>
    </div>

    <h4 class="profile-user-sidebar-full-name" >Созвездие  </h4>
  ...
  <div class="col-md-9" >
        ...
        <h3> <strong><?php echo translate("tr_ffc009f302516a8402667d060e48794b"); ?></strong> </h3>

        <div class="my-tabs-items-small mt20">
            <a class="my-tabs-item <?php if(!$_GET['status']){ echo 'active'; }; ?>" href="<?php echo outRoute('profile-ads'); ?>" ><?php echo translate("tr_1cc7e7972b8c9daa5e9c8e94483acc7d"); ?> <span><?php echo $template->component->profile->outCountAdsUserByStatus(); ?></span> </a>
            <a class="my-tabs-item <?php if(compareValues($_GET['status'], 'active')){ echo 'active'; }; ?>" href="<?php echo requestBuildVars(['status'=>'active']); ?>" ><?php echo translate("tr_c83f7ab515c5cf6bed69213f55f917c7"); ?> <span><?php echo $template->component->profile->outCountAdsUserByStatus('active'); ?></span> </a>
            <a class="my-tabs-item <?php if(compareValues($_GET['status'], 'sold')){ echo 'active'; }; ?>" href="<?php echo requestBuildVars(['status'=>'sold']); ?>" ><?php echo translate("tr_af43d5369e953088e86102931ef6be20"); ?> <span><?php echo $template->component->profile->outCountAdsUserByStatus('sold'); ?></span> </a>
            <a class="my-tabs-item <?php if(compareValues($_GET['status'], 'moderation')){ echo 'active'; }; ?>" href="<?php echo requestBuildVars(['status'=>'moderation']); ?>" ><?php echo translate("tr_d9d74d385363cf3fdf9c1e62b484acca"); ?> <span><?php echo $template->component->profile->outCountAdsUserByStatus('moderation'); ?></span> </a>
            <a class="my-tabs-item <?php if(compareValues($_GET['status'], 'waiting_payment')){ echo 'active'; }; ?>" href="<?php echo requestBuildVars(['status'=>'waiting_payment']); ?>" ><?php echo translate("tr_c3778e4b26fed47232f25379c67c0010"); ?> <span><?php echo $template->component->profile->outCountAdsUserByStatus('waiting_payment'); ?></span> </a>
            <a class="my-tabs-item <?php if(compareValues($_GET['status'], 'archive')){ echo 'active'; }; ?>" href="<?php echo requestBuildVars(['status'=>'archive']); ?>" ><?php echo translate("tr_9e1ad28d8e86e5df9b53cb1f360e7114"); ?> <span><?php echo $template->component->profile->outCountAdsUserByStatus('archive'); ?></span> </a>
        </div>

        <a class="btn-custom button-color-scheme2 mt20" href="<?php echo outRoute('ad-create'); ?>" ><?php echo translate("tr_6a597fed338ace644982313b3cfbead4"); ?></a>

        <?php if($data->ads):; ?>

          <div class="row row-cols-2 g-2 g-lg-3 mt25" ><?php echo $data->ads;; ?></div>
        ...
        <?php else:; ?>
          ...
          <div class="mt40 not-found-title-container" >
             ...
             <p><?php echo translate("tr_c3b91a7a70cf6227c8277790bd2e5efc"); ?></p>           
          </div>
