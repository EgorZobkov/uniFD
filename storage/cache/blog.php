...
<link rel="canonical" href="<?php echo $template->component->blog_categories->buildAliases((array)$data->category); ?>"/>
...
<div class="container mt20" >
    ...
    <nav aria-label="breadcrumb" class="mb15" >
      ...
      <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
        ...
        <li class="breadcrumb-item" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
          <a itemprop="item" href="<?php echo outRoute('blog'); ?>">
          <span itemprop="name"><?php echo translate("tr_103a554114af7c598a4f835ac463722e"); ?></span></a>
          <meta itemprop="position" content="2">
        </li>

        <?php echo $template->component->blog->outBreadcrumb();; ?>
    ...
    <div class="row" >
      ...
      <div class="col-md-12" >
        ...
        <div class="blog-widget-categories-or-subcategories mt25" >
          ...
          <?php echo $template->component->blog_categories->outCategoriesOrSubCategories();; ?>
  ...
  <div class="container-item-grid-skeleton" >
    ...
    <div class="container-item-grid-content-skeleton" >
       ...
       <div class="container-item-grid-content-title-skeleton" ></div>
          ...
          <input type="hidden" name="blog_category_id" value="<?php echo $data->category ? $data->category->id : '0'; ?>" >
