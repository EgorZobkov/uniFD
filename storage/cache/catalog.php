...
<link rel="canonical" href="<?php echo $template->component->ads_categories->buildAliases((array)$template->component->catalog->data->category); ?>"/>
               ...
               <div class="col-lg-3 text-end" >
                  ...
                  <div class="header-wow-top-list-icon" >
                    ...
                    <div class="header-wow-top-list-profile">
                        <div class="header-user-dropdown-menu"> <span> <span class="mini-avatar"> <span class="mini-avatar-img">     <img class="image-autofocus" src="https://test.my-fd.ru/storage/images/no-image.png">
     </span> </span>
    </span>
  ...
  <div class="col-lg-12" >
    ...
    <nav aria-label="breadcrumb" class="mb15" >
      ...
      <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
        ...
        <?php if($template->component->catalog->data->category):; ?>
        <?php echo $template->component->catalog->outBreadcrumb();; ?>
        <?php else:; ?>
        <li class="breadcrumb-item" itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
          <span itemprop="name"><?php echo $seo->h1;; ?></span>
    ...
    <h1 class="font-bold" ><?php echo $seo->h1;; ?></h1>
    ...
    <div class="widget-categories-container" >
      ...
      <div >
        <div class="row" >
          <?php echo $template->component->ads_categories->outCategoriesOrSubCategoriesByCatalog();; ?>
        </div>
      </div>

      <div class="widget-categories-or-subcategories-button-all" >
         
        <span class="btn-custom-mini button-color-scheme1"><?php echo translate("tr_b904c7e4dbcaafdca6a56f72c3700eb7"); ?></span>
    ...
    <?php echo $template->component->catalog->outPromoBanners(); ?>
    <?php echo $template->component->catalog->outStories(); ?>

    <?php echo $template->component->ads_filters->outFilterLinks(); ?>
    ...
    <div class="row mt25" >
      ...
      <div class="col-md-3 col-12 d-none d-lg-block" >
        ...
        <div class="catalog-sidebar" >
          ...
          <?php echo $template->component->catalog->buildParamsForm($_GET, $template->component->catalog->data->category->id);; ?>

          <div class="params-buttons-sticky" >
            
            <?php echo $template->component->ads_filters->outButtonExtraFilters($template->component->catalog->data->category->id); ?>
            
            <button class="btn-custom button-color-scheme1 width100 actionApplyLiveFilters" ><?php echo translate("tr_130bbbc068f7a58df5d47f6587ff4b43"); ?></button>
          ...
          <div class="row" >
            <div class="col-md-6 col-12" >
              ...
              <div class="catalog-container-links-inline" >
               <?php if($template->component->profile->isSavedSearch()):; ?>
               <span class="actionSaveSearch catalog-container-links-inline-item" ><?php echo translate("tr_f6acf24dca325b44869ec3fe34ef5083"); ?></span>
               <?php else:; ?>
                <span class="actionSaveSearch catalog-container-links-inline-item" ><?php echo translate("tr_852be42059679d4e4fef58aad5f3fa2f"); ?></span>
               <?php endif; ?>

               <?php if($template->component->catalog->data->category->change_city_status):; ?>
               <a class="catalog-container-links-inline-item" href="<?php echo $template->component->catalog->outLinkMap();; ?>" ><?php echo translate("tr_666bf8c669656fd744a2ae5e889ca47e"); ?></a>
               <?php endif; ?>
            ...
            <div class="col-md-6 col-12 text-end" >
              ...
              <div class="catalog-container-options-links-inline catalog-container-options-links-inline-sorting" >
                <div><?php echo $template->component->catalog->outLinkSorting();; ?></div>
                <div>
                  <div class="catalog-container-options-view-item text-end catalog-action-change-view-item" >

                    <span <?php if($template->component->catalog->getViewItems($template->component->catalog->data->category->id) == "grid"):; ?> class="active" <?php endif;; ?> data-view="grid" > <i class="ti ti-layout-grid"></i> </span>
                    <span <?php if($template->component->catalog->getViewItems($template->component->catalog->data->category->id) == "list"):; ?> class="active" <?php endif;; ?> data-view="list" > <i class="ti ti-list-details"></i> </span>                
    ...
    <div class="container-item-grid-content-skeleton" >
     ...
     <?php if($seo->h2):; ?>
         <section class="home-seo-text mt30" >
            <h2 class="font-bold mb15" ><?php echo $seo->h2; ?></h2>
            <?php echo $seo->text; ?>
         </section>
     <?php endif; ?>
...
<?php echo $template->ui->tpl('modals/extra-filters-modal.tpl')->modal("extraFilters", "medium", ["filters"=>$_GET["filter"], "category_id"=>$template->component->catalog->data->category->id]); ?>
