               ...
               <div class="col-lg-3 text-end" >
                  ...
                  <div class="header-wow-top-list-icon" >
                    ...
                    <div class="header-wow-top-list-profile">
                        <div class="header-user-dropdown-menu"> <span> <span class="mini-avatar"> <span class="mini-avatar-img">     <img class="image-autofocus" src="/storage/users/avatars/4a09dfe43cd0c5112638c86e42eb3a20.webp">
     </span> </span>
    </span>
  ...
  <div class="col-md-3" >
    ...
    <div class="profile-user-sidebar-avatar" >
      <div>
        ...
        <img class="image-autofocus" src="https://my-fd.ru/storage/users/avatars/4a09dfe43cd0c5112638c86e42eb3a20.webp">
      </div>
    </div>

    <h4 class="profile-user-sidebar-full-name" >Kwimmrr  </h4>
