...
<meta property="og:url" content="<?php echo $template->component->profile->linkUserCard($data->user->alias); ?>">
<meta property="og:image" content="<?php echo $template->storage->name($data->user->avatar)->host(true)->get(); ?>">
...
<div class="row" >
          ...
          <div class="user-avatar-by-stories" >
            <div>
                <div class="user-avatar-by-stories-circle" >
                    <img class="image-autofocus" src="/storage/users/avatars/bf4466d675e76dae5da10b4f1daad97f.webp">
                </div>
            </div>
          </div>
      </div>
  ...
  <h4 class="profile-user-sidebar-full-name" >Егор  <span class="user-label-verification actionOpenStaticModal" data-modal-target="verificationUserInfo" ><i class="ti ti-square-rounded-check"></i></span></h4>
  ...
  <div class="container-user-rating-stars menu-user-rating-stars" >
      ...
      <a href="https://t.me/pingwinn" target="_blank" rel="noopener">
        <i class="ti ti-brand-telegram"></i>
        <span>@pingwinn</span>
      </a>
    </div>
  
  <button class="btn-custom button-color-scheme1 width100 mt30 actionOpenDialogueSendMessage" data-params="%7B%22whom_user_id%22%3A%221%22%2C%22token%22%3A%22544c6825dd5c93e2fbd8fcef0f1d7099%22%7D" >Написать</button>

      <button class="btn-custom button-color-scheme2 width100 mt10 actionSubscribeUser" data-id="1" >Подписаться</button>
  ...
  <div class="col-md-9" >
        ...
        <a class="btn-custom-mini button-color-scheme2 mb10" href="<?php echo $template->component->profile->linkUserCard($data->user->alias); ?>" ><i class="ti ti-chevron-left"></i> <?php echo translate("tr_2b0b0225a86bb67048840d3da9b899bc"); ?></a>

        <h3> <strong><?php echo translate("tr_083ab3d9a9221cf6a1641c2c7c5f0d3c"); ?></strong> </h3>

        <div class="my-tabs-items-small mt20">
            <a class="my-tabs-item <?php if(compareValues($_GET['status'], 'active') || !$_GET['status']){ echo 'active'; }; ?>" href="<?php echo requestBuildVars(['status'=>'active']); ?>" ><?php echo translate("tr_c83f7ab515c5cf6bed69213f55f917c7"); ?> <span><?php echo $template->component->profile->outCountAdsUserByStatus('active',$data->user->id); ?></span> </a>
            <a class="my-tabs-item <?php if(compareValues($_GET['status'], 'sold')){ echo 'active'; }; ?>" href="<?php echo requestBuildVars(['status'=>'sold']); ?>" ><?php echo translate("tr_af43d5369e953088e86102931ef6be20"); ?> <span><?php echo $template->component->profile->outCountAdsUserByStatus('sold',$data->user->id); ?></span> </a>
        </div>

        <?php if($data->ads):; ?>

          <div class="row mt25" ><?php echo $data->ads;; ?></div>
