               ...
               <div class="col-lg-3 text-end" >
                  ...
                  <div class="header-wow-top-list-icon" >
                    ...
                    <div class="header-wow-top-list-profile">
                        <div class="header-user-dropdown-menu"> <span> <span class="mini-avatar"> <span class="mini-avatar-img">     <img class="image-autofocus" src="/storage/users/avatars/1d5a75d07b1ddf7b4fae9757a7326103.webp">
     </span> </span>
    </span>
...
<h3 class="font-bold mb20" ><?php echo $data->title; ?></h3>
...
<div class="ad-create-categories-container" style="display: none;" >
    ...
    <div class="row" >
      <div class="col-md-4" >
        ...
        <div class="ad-create-categories-container-items" ><button class="btn-custom button-color-scheme2 mb15 ad-create-categories-close" ><?php echo translate("tr_2b0b0225a86bb67048840d3da9b899bc"); ?></button> <?php echo $template->component->ads_categories->outMainCategoriesInAdCreate(); ?></div>
...
<div class="ad-create-options-container" style="display: block;" >
  ...
  <div class="ad-create-content-container" >
      <?php echo $template->component->ads->getContentAndOptions(["category_id"=>$data->category_id, "is_admin"=>$data->isAdmin],$data); ?>
  </div>

  <input type="hidden" name="ad_id" value="<?php echo $data->id; ?>" >
  <input type="hidden" name="category_id" value="<?php echo $data->category_id; ?>" >
  <input type="hidden" name="geo_city_id" value="<?php echo $data->city_id; ?>" >
  <input type="hidden" name="geo_address_latitude" value="<?php echo $data->address_latitude; ?>" >
  <input type="hidden" name="geo_address_longitude" value="<?php echo $data->address_longitude; ?>" >
  <input type="hidden" name="geo_latitude" value="<?php echo $data->address_latitude ?: $data->geo_latitude; ?>" >
  <input type="hidden" name="geo_longitude" value="<?php echo $data->address_longitude ?: $data->geo_longitude; ?>" >

  <button class="btn-custom-big button-color-scheme3 adActionUpdate mt30 mb30" ><?php echo translate("tr_74ea58b6a801f0dce4e5d34dbca034dc"); ?></button>
...
<?php echo $template->component->geo->outMapChangeAddressInAdCreate(); ?>
