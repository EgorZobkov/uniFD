               ...
               <div class="col-lg-3 text-end" >
                  ...
                  <div class="header-wow-top-list-icon" >
                    ...
                    <div class="header-wow-top-list-profile">
                        <div class="header-user-dropdown-menu"> <span> <span class="mini-avatar"> <span class="mini-avatar-img">     <img class="image-autofocus" src="/storage/users/avatars/d59817884766e883f4b6c6b2b3795c88.webp">
     </span> </span>
    </span>
...
<div class="row" >
  ...
  <div class="col-md-3" >
    ...
    <div class="profile-user-sidebar-avatar" >
      <div>
        ...
        <img class="image-autofocus" src="https://my-fd.ru/storage/users/avatars/d59817884766e883f4b6c6b2b3795c88.webp">
      </div>
    </div>

    <h4 class="profile-user-sidebar-full-name" >Yujin Arromasu </h4>
  ...
  <div class="col-md-9" >
        ...
        <div class="my-tabs-items my-tabs-items-medium mt20">
            <a class="my-tabs-item <?php if(!$_GET['tab'] || compareValues($_GET['tab'], 'ads')){ echo 'active'; }; ?>" href="?tab=ads" ><?php echo translate("tr_083ab3d9a9221cf6a1641c2c7c5f0d3c"); ?></a>
            <a class="my-tabs-item <?php if(compareValues($_GET['tab'], 'searches')){ echo 'active'; }; ?>" href="?tab=searches" ><?php echo translate("tr_10b80a180d9f5ab5272132c27430a67e"); ?></a>
            <a class="my-tabs-item <?php if(compareValues($_GET['tab'], 'subscriptions')){ echo 'active'; }; ?>" href="?tab=subscriptions" ><?php echo translate("tr_4a2adbe0c408017611fe5cc95cbf1a8e"); ?></a>
            <a class="my-tabs-item <?php if(compareValues($_GET['tab'], 'viewed')){ echo 'active'; }; ?>" href="?tab=viewed" ><?php echo translate("tr_9b236849273d8b0743667e074f592454"); ?></a>
        </div>
        ...
        <?php else:; ?>
          ...
          <div class="mt40 not-found-title-container" >
             ...
             <p><?php echo translate("tr_d716fec18159de84dae4b5a94795ebac"); ?></p>           
          </div>
