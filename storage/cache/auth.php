      ...
      <div class="authentication-inner row m-0">
        ...
        <div class="d-flex col-12 col-xl-5 align-items-center authentication-bg p-sm-12 p-6">
          <div class="w-px-400 mx-auto mt-12 pt-5">
              ...
              <h3 class="mb-3 pt-2"><?php echo translate("tr_139ff22e13842f1a599c1c3c9d2a7ee7"); ?> <?php echo translate("tr_bf44672226a49cab577451711c25eb59"); ?> <?php echo $template->settings->project_name; ?>!👋</h3>

              <form class="formAuthentication" method="get">
                <div class="mb-3">
                  <label for="email" class="form-label"><?php echo translate("tr_ce8ae9da5b7cd6c3df2929543a9af92d"); ?></label>
                  <input type="text" class="form-control" name="login" autofocus />
                </div>
                <div class="mb-3 form-password-toggle">
                  <div class="d-flex justify-content-between">
                    <label class="form-label" for="password"><?php echo translate("tr_5ebe553e01799a927b1d045924bbd4fd"); ?></label>
                    <a href="<?php echo $template->router->getRoute('dashboard-forgot'); ?>">
                      <small><?php echo translate("tr_38bb0dceaeccc88640465bf53a63481f"); ?></small>
                    </a>
                  </div>
                ...
                <button class="btn btn-primary waves-effect waves-light w-100 formAuthenticationButtonEnter" ><?php echo translate("tr_63a753751e8899416d62b1d1bbb61720"); ?></button>
              </form>
...
<?php echo $template->ui->tpl("captcha.tpl")->modal("captcha", "nano");; ?>