...
<div class="row" >
          ...
          <div class="user-avatar-by-stories" >
            <div>
                <div class="user-avatar-by-stories-circle" >
                    <img class="image-autofocus" src="/storage/users/avatars/1d5a75d07b1ddf7b4fae9757a7326103.webp">
                </div>
            </div>
          </div>
      </div>
  ...
  <h4 class="profile-user-sidebar-full-name" >cain  </h4>
  ...
  <div class="container-user-rating-stars menu-user-rating-stars" >
      ...
      <a href="https://t.me/cain_reliant" target="_blank" rel="noopener">
        <i class="ti ti-brand-telegram"></i>
        <span>@cain_reliant</span>
      </a>
    </div>
  
  <button class="btn-custom button-color-scheme1 width100 mt30 actionOpenDialogueSendMessage" data-params="%7B%22whom_user_id%22%3A%229%22%2C%22token%22%3A%2292c5301a093f1665147b928c8dd4b835%22%7D" >Написать</button>

      <button class="btn-custom button-color-scheme2 width100 mt10 actionSubscribeUser" data-id="9" >Подписаться</button>
  ...
  <div class="col-md-9" >
    ...
    <a class="btn-custom-mini button-color-scheme1 mt10" href="<?php echo outRoute('user-card-ads', [$data->user->alias]); ?>" ><?php echo translate("tr_d572de2b18482a4db2968a7fe6ca674f"); ?></a>

    <?php else:; ?>

      <div class="mt40 not-found-title-container" >
         <div class="not-found-title-container-image" >🧐</div>
         <p><?php echo translate("tr_abe40b620b33b61056d38cfd4f6e2ff2"); ?></p>           
      </div>

    <?php endif;; ?>

    <h3 class="mt30" > <strong><?php echo translate("tr_1c3fea01a64e56bd70c233491dd537aa"); ?></strong> </h3>
    ...
    <?php else:; ?>
      ...
      <div class="mt40 not-found-title-container" >
         <div class="not-found-title-container-image" >🧐</div>
         <p><?php echo translate("tr_5781a644de7a7276ce1b079f9f27fafe"); ?></p>           
      </div>
