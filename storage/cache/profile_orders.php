...
<div class="row" >
  ...
  <div class="col-md-9" >
        ...
        <div class="my-tabs-items my-tabs-items-medium mt20">
            <a class="my-tabs-item <?php if(!$_GET['tab'] || compareValues($_GET['tab'], 'buy')){ echo 'active'; }; ?>" href="?tab=buy" ><?php echo translate("tr_82329f6f0fb076026c94fde71d8c2136"); ?></a>
            <a class="my-tabs-item <?php if(compareValues($_GET['tab'], 'sell')){ echo 'active'; }; ?>" href="?tab=sell" ><?php echo translate("tr_e8d5f643de71af2e7d7aceae72e859a9"); ?></a>
        </div>
        ...
        <?php else:; ?>
          ...
          <div class="mt40 not-found-title-container" >
             ...
             <p><?php echo translate("tr_efb9a0cf37e542160d0fcd33f5cc9f5c"); ?></p>           
          </div>
