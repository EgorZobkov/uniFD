               ...
               <div class="col-lg-3 text-end" >
                  ...
                  <div class="header-wow-top-list-icon" >
                    ...
                    <div class="header-wow-top-list-profile">
                        <div class="header-user-dropdown-menu"> <span> <span class="mini-avatar"> <span class="mini-avatar-img">     <img class="image-autofocus" src="/storage/users/avatars/bf4466d675e76dae5da10b4f1daad97f.webp">
     </span> </span>
    </span>
  ...
  <div class="col-md-3" >
    ...
    <div class="profile-user-sidebar-avatar" >
      <div>
        ...
        <img class="image-autofocus" src="https://test.my-fd.ru/storage/users/avatars/bf4466d675e76dae5da10b4f1daad97f.webp">
      </div>
    </div>

    <h4 class="profile-user-sidebar-full-name" >Егор 2  <span class="user-label-verification actionOpenStaticModal" data-modal-target="verificationUserInfo" ><i class="ti ti-square-rounded-check"></i></span></h4>
  ...
  <div class="col-md-9" >
    ...
    <div class="profile-home-sections" >
      ...
      <section>
        ...
        <?php if($template->settings->verification_users_status):; ?>

          <?php if(!$template->user->data->verification_status):; ?>

          <?php else:; ?>

          <div class="profile-home-sections-info-item">
          <h5> <strong><?php echo translate("tr_8b172472598ea96545ea248dd2b60d0e"); ?></strong> </h5>
          </div>
      ...
      <?php if($data->orders):; ?>
      <section>
      <h3> <strong><?php echo translate("tr_0905527faec7de502c0e62ce318af892"); ?></strong> </h3>
      <div class="row row-cols-2 g-2 g-lg-3 mt25" ><?php echo $data->orders; ?></div>

      <a class="btn-custom-mini button-color-scheme2 mt10" href="<?php echo outRoute('profile-orders'); ?>" ><?php echo translate("tr_4afd2ca38e5bba8fb023f3bce3e22838"); ?></a>
      </section>
      <?php endif; ?>
      ...
      <section>
        <?php if($data->ads):; ?>
          ...
          <a class="btn-custom button-color-scheme1 mt10" href="<?php echo outRoute('ad-create'); ?>" ><?php echo translate("tr_6a597fed338ace644982313b3cfbead4"); ?></a>

          <div class="row row-cols-2 g-2 g-lg-3 mt25" ><?php echo $data->ads;; ?></div>

          <a class="btn-custom-mini button-color-scheme2 mt10" href="<?php echo outRoute('profile-ads'); ?>" ><?php echo translate("tr_d572de2b18482a4db2968a7fe6ca674f"); ?></a>
        <?php else:; ?>
          <h3> <strong><?php echo translate("tr_698ee392dad3099a37dae5c98118fb2d"); ?></strong> </h3>
          <a class="btn-custom button-color-scheme1 mt10" href="<?php echo outRoute('ad-create'); ?>" ><?php echo translate("tr_6a597fed338ace644982313b3cfbead4"); ?></a>
        <?php endif; ?>
      </section>
      ...
      <section>
      <h3> <strong><?php echo translate("tr_2fc413929104c1a09ae0a66c48ce0902"); ?></strong> </h3>
      <div class="row row-cols-2 g-2 g-lg-3 mt25" ><?php echo $data->favorites; ?></div>
      </section>
      <?php endif; ?>

      <?php if($data->reviews):; ?>
      <section>
      <h3> <strong><?php echo translate("tr_1c3fea01a64e56bd70c233491dd537aa"); ?></strong> </h3>
      <div class="row row-cols-2 g-2 g-lg-3 mt25" ><?php echo $data->reviews; ?></div>

      <a class="btn-custom-mini button-color-scheme2 mt10" href="<?php echo outRoute('profile-reviews'); ?>" ><?php echo translate("tr_4fbf45456be84d545b8a3052079e0173"); ?></a>
      </section>
      <?php endif; ?>
...
<?php if($template->settings->registration_bonus_status):; ?>
<?php echo $template->ui->tpl('modals/profile-registration-bonus.tpl')->modal("profileRegistrationBonus", "small"); ?>
<?php endif; ?>
