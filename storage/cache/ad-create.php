...
<h3 class="font-bold mb20" ><?php echo $seo->h1;; ?></h3>
...
<div class="ad-create-categories-container" >
    ...
    <div class="row" >
      <div class="col-md-4" >
        ...
        <div class="ad-create-categories-container-items" ><?php echo $template->component->ads_categories->outMainCategoriesInAdCreate();; ?></div>
...
<div class="ad-create-options-container" >
  ...
  <button class="btn-custom-big button-color-scheme3 adActionPublication mt30 mb30" ><?php echo translate("tr_e9c3a648ce9e5dcf3c96940e682a72a2"); ?></button>
