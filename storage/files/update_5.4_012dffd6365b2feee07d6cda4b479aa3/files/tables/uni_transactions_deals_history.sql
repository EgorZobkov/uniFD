...
CREATE TABLE `uni_transactions_deals_history` (
  `id` int NOT NULL,
...
--
-- Индексы таблицы `uni_transactions_deals_history`
--
ALTER TABLE `uni_transactions_deals_history`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `uni_transactions_deals_history`
--
ALTER TABLE `uni_transactions_deals_history`
