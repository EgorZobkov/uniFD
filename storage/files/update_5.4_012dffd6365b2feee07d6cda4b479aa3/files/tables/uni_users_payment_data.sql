...
CREATE TABLE `uni_users_payment_data` (
  `id` int NOT NULL,
...
--
-- Индексы таблицы `uni_users_payment_data`
--
ALTER TABLE `uni_users_payment_data`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `uni_users_payment_data`
--
ALTER TABLE `uni_users_payment_data`
