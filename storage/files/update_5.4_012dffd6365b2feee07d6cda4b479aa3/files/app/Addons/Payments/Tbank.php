        ...
        if($this->data->secure_deal_available){
            ...
            $secure_deal_available = '
                ...
                <div class="col-12">
                  ...
                  <label class="form-label mb-2" >'.translate("Терминал для выплат").'</label>
                ...
                <div class="col-12 mt-3">
                  ...
                  <label class="form-label mb-2" >'.translate("Секретный ключ для выплат").'</label>
        ...
        <form class="integrationPaymentForm" >
            ...
            <div class="row">
                ...
                <div class="col-12 mt-3">
                  ...
                  <label class="form-label mb-2" >'.translate("Терминал для оплаты").'</label>
                ...
                <div class="col-12 mt-3">
                  ...
                  <label class="form-label mb-2" >'.translate("Секретный ключ для оплаты").'</label>
