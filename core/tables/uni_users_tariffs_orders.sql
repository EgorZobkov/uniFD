...
CREATE TABLE `uni_users_tariffs_orders` (
  `id` int NOT NULL,
...
--
-- Индексы таблицы `uni_users_tariffs_orders`
--
ALTER TABLE `uni_users_tariffs_orders`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `uni_users_tariffs_orders`
--
ALTER TABLE `uni_users_tariffs_orders`
