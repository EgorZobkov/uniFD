...
INSERT INTO `uni_system_delivery_services` (`id`, `name`, `params`, `alias`, `status`, `image`, `available_price_min`, `available_price_max`, `min_weight`, `max_weight`) VALUES
(2, 'Яндекс.Доставка', NULL, 'yandex', 1, NULL, 1, 100000, 100, 15000),
(3, 'Достависта', NULL, 'dostavista', 1, NULL, 1, 100000, 100, 15000),
(4, 'Сдэк', NULL, 'cdek', 1, NULL, 1, 100000, 100, 15000);
